...
// Mockito.mock(CountryRepository.class);

// @Autowired
// DiferenciaEntreFechas diferenciaEntreFechas = new DiferenciaEntreFechas();

// @Autowired
// IndependencyController independencyController = new
// IndependencyController(countryRepositoryMock,
...
// Assertions.assertEquals("Republica Dominicana",
// respuestaServicio.getBody().getCountryName());
// }
